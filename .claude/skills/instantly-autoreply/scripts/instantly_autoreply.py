...
if __name__ == "__main__":
    ...
    # Find token.json — check multiple locations
    from pathlib import Path
    token_candidates = [
        Path('token.json'),
        Path(__file__).resolve().parent.parent / 'token.json',
        Path(__file__).resolve().parent.parent.parent.parent / 'token.json',
        Path(__file__).resolve().parent.parent.parent / 'gmaps-leads' / 'token.json',
    ]
