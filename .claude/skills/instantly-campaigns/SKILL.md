...
Before creating campaigns, confirm with the user:
- **What:** Creating {N} campaigns in Instantly for {client_name}
- **Affects:** Instantly account, sending reputation, prospect inboxes
- **Confirm:** "Campaigns will be created and can start sending when leads are uploaded. Proceed?"

Before uploading leads to campaigns, confirm:
- **What:** Uploading {lead_count} leads across {N} campaigns
- **Affects:** Leads will receive first email within campaign schedule
- **Confirm:** "First emails will send within 24hrs of campaign activation. Proceed?"
