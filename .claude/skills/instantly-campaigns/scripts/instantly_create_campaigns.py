...
EXAMPLES_PATHS = [
    Path(__file__).parent.parent / ".tmp" / "instantly_campaign_examples" / "campaigns.md",
    # scripts/ -> instantly-campaigns/ -> skills/ -> .claude/ -> workspace root
    Path(__file__).resolve().parent.parent.parent.parent.parent / ".tmp" / "instantly_campaign_examples" / "campaigns.md",
]
            ...
            "schedules": [
                {
                    ...
                    # NOTE: Instantly API v2 has a restrictive timezone enum.
                    # "America/Chicago" is used because not all IANA values are accepted.
                    # TODO: Test if "Europe/London" works for UK-based operations.
